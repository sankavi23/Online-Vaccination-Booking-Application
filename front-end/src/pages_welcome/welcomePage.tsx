...
{/**App Bar */}
            ...
            <div style={ sectionStyle }>
                <div >
                    ...
                    <div></div>
                    <b style={{color:'white',fontSize:90,marginLeft:'15%'}}>Get Your Vaccination
                       
                    </b>
                    <div style={{marginTop:-50}}>
                    <b  style={{color:'white',fontSize:90,marginLeft:'20%'}}>Boost Your Health
                    
                    </b></div>
                    <div style={{fontSize:30,marginLeft:'35%'}}>
                        <a style={{color:'white'}}>Get Your Immunity</a>
                        <br/>
                        ...
                        <div style={{border: '3px solid white',marginTop:20,marginLeft:50,width:340}}>
                        <a style={{color:'black',fontSize:25,marginLeft:10}}>GET YOUR VACCINATION </a>
