...
import { getAllMyVaccines } from "../../service/api";
...
const MyVaccinesTable = () => {
  ...
  useEffect(() => {
    getAllMyVaccines(UTILS.USER_ID)
      .then((res) => {
        console.log({ res });
        setTableData(res.appointment);
      })
      .catch((err) => {
        console.log({ err });
      });
          ...
          <TableBody>
            {tableData.map((row: any) => (
              <StyledTableRow key={row._id}>
                ...
                <StyledTableCell>{row.vaccineType}</StyledTableCell>
                <StyledTableCell>{row.appointmentId}</StyledTableCell>
                <StyledTableCell>{row.hospital?.firstName}</StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
        </Table>
